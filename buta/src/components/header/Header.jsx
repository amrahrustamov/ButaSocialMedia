      ...
      <div className="containerHeader">
            ...
            <div className="col-lx-3 col-lg-3 col-md-4 col-sm-4 rightPartOfHeader">
              <div className="containerOfRightPart">
                ...
                <div className='profilePhoto'><Link><img src="https://images.ctfassets.net/h6goo9gw1hh6/2sNZtFAWOdP1lmQ33VwRN3/24e953b920a9cd0ff2e1d587742a2472/1-intro-photo-final.jpg?w=1200&h=992&fl=progressive&q=70&fm=jpg" alt="logo" /></Link></div>
              </div>
            </div>
      </div>
    </header>
